...
ServerTab.Position = UDim2.new(0, 135, 0, 45) -- Main frame offset
...
EventStatus.Position = UDim2.new(0, 10, 0, 10) -- Pushed down cleanly inside the tab
...
-- Move the buttons down slightly as well to match the new layout
-- (Find your HopBtn and LowHopBtn positions and update them below if needed)
